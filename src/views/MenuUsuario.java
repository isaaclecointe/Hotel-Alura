...
public class MenuUsuario extends JFrame {
	...
	public MenuUsuario() {
		...
		panelMenu.setBackground(new Color(43, 166, 187));
		panelMenu.setBounds(0, 0, 281, 609);
		...
		btnRegistro.setBackground(new Color(43, 166, 187));
		...
		btnBusqueda.setBackground(new Color(43, 166, 187));
		...
		btnCerrarSesion.setBackground(new Color(43, 166, 187));
		btnCerrarSesion.setBounds(0, 526, 257, 56);
		panelMenu.add(btnCerrarSesion);
		btnCerrarSesion.setLayout(null);
		
		JLabel lblNewLabel_4 = new JLabel("Cerrar Sesion");
		lblNewLabel_4.setVerticalAlignment(SwingConstants.BOTTOM);
		lblNewLabel_4.setFont(new Font("Segoe UI Variable", Font.BOLD, 16));
		lblNewLabel_4.setForeground(new Color(255, 255, 255));
		lblNewLabel_4.setBounds(10, 0, 169, 48);
		btnCerrarSesion.add(lblNewLabel_4);
		lblNewLabel_4.setIcon(new ImageIcon("C:\\Users\\PC\\Documents\\proyecto hotel\\challenge-one-alura-hotel-latam-repositorio-base\\challenge-one-alura-hotel-latam-repositorio-base\\src\\imagenes\\20240220_125414_0000.png"));
	    ...
	    panelFecha.setBackground(new Color(159, 187, 43));
