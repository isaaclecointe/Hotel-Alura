...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped(int idReserva) {
		...
		labelGuardar.setBounds(0, 0, 164, 35);
		btnguardar.add(labelGuardar);
		labelGuardar.setIcon(new ImageIcon("C:\\Users\\PC\\Documents\\challenge-one-alura-hotel-latam-repositorio-base\\challenge-one-alura-hotel-latam-repositorio-base\\bin\\imagenes\\disquete.png"));
		labelGuardar.setHorizontalAlignment(SwingConstants.CENTER);
		labelGuardar.setForeground(new Color(12, 138, 199));
		labelGuardar.setFont(new Font("Dialog", Font.PLAIN, 20));
		...
		separator_1_2_5_1.setBackground(new Color(0, 255, 255));
		separator_1_2_5_1.setBounds(698, 606, 189, 2);
